                        ...
                        >
                            ...
                            <div className="flex flex-col items-center text-center space-y-6">
                                ...
                                <div className="relative h-48 w-48 flex items-center justify-center">
                                    ...
                                    <div className="absolute inset-0 flex flex-col items-center justify-center">
                                        ...
                                        <span className="text-[10px] uppercase font-black tracking-widest opacity-40">
                                            {lang === 'pt' ? 'Resiliência Neural' : lang === 'es' ? 'Resiliencia Neural' : 'Neural Resilience'}
                                        </span>
                                    </div>
                                </div>
                                ...
                                <p className="text-sm text-muted-foreground leading-relaxed font-medium">
                                    {lang === 'pt'
                                        ? 'Capacidade do seu sistema central de converter pressão externa e caos em crescimento e adaptação acelerada.'
                                        : lang === 'es'
                                            ? 'Capacidad de su sistema central para convertir la presión externa y el caos en crecimiento y adaptación acelerada.'
                                            : 'Your central system\'s ability to convert external pressure and chaos into growth and accelerated adaptation.'}
                                </p>
                            </div>
                        </motion.div>
                            ...
                            <div className="relative z-10 space-y-8">
                                <div className="space-y-2">
                                    <span className="text-[10px] font-black uppercase tracking-[0.3em] text-primary opacity-60 italic">
                                        {lang === 'pt' ? 'Identidade de Estado' : lang === 'es' ? 'Identidad de Estado' : 'State Identity'}
                                    </span>
                                    <h3 className="text-4xl font-black uppercase tracking-tighter leading-tight italic">
                                        {diagnosis.v3Insights?.archetype || (lang === 'pt' ? 'O Observador' : lang === 'es' ? 'El Observador' : 'The Observer')}
                                    </h3>
                                </div>
                                ...
                                <div className="space-y-6">
                                    <div className="grid grid-cols-2 gap-4">
                                        <div className="p-4 rounded-2xl bg-background/50 border border-border/10 space-y-1">
                                            <span className="text-[9px] font-black uppercase tracking-widest opacity-40">{lang === 'pt' ? 'Tendência' : lang === 'es' ? 'Tendencia' : 'Tendency'}</span>
                                            <p className="text-xs font-bold">{lang === 'pt' ? 'Adaptativo' : lang === 'es' ? 'Adaptativo' : 'Adaptive'}</p>
                                        </div>
                                        <div className="p-4 rounded-2xl bg-background/50 border border-border/10 space-y-1">
                                            <span className="text-[9px] font-black uppercase tracking-widest opacity-40">{lang === 'pt' ? 'Risco' : lang === 'es' ? 'Riesgo' : 'Risk'}</span>
                                            <p className="text-xs font-bold text-rose-500">{lang === 'pt' ? 'Burnout Latente' : lang === 'es' ? 'Burnout Latente' : 'Latent Burnout'}</p>
                                        </div>
                                    </div>

                                    <p className="text-muted-foreground text-sm leading-relaxed italic">
                                        {lang === 'pt'
                                            ? 'Este perfil reflete um alto nível de execução, mas com uma estrutura de suporte que começa a mostrar sinais de fadiga sistêmica.'
                                            : lang === 'es'
                                                ? 'Este perfil refleja un alto nivel de ejecución, pero con una estructura de soporte que comienza a mostrar signos de fatiga sistémica.'
                                                : 'This profile reflects a high level of execution, but with a support structure starting to show signs of systemic fatigue.'}
                                    </p>
                                    ...
                                    <div className="pt-4 flex items-center justify-between">
                                        ...
                                        <span className="text-[10px] font-bold opacity-30">
                                            {lang === 'pt'
                                                ? 'Perfil Compartilhado por 4% dos usuários'
                                                : lang === 'es'
                                                    ? 'Perfil compartido por el 4% de los usuarios'
                                                    : 'Profile shared by 4% of users'}
                                        </span>
                                    </div>
                                </div>
                            </div>
                    ...
                    {isUnlocked && (
                        <>
                                ...
                                <div className="p-10 rounded-[3rem] bg-card/40 border border-border/40 shadow-2xl relative overflow-hidden">
                                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                                        ...
                                        <div className="p-8 rounded-2xl bg-muted/20 border border-border/40 space-y-4 flex flex-col justify-center text-center italic">
                                            <Sparkles className="h-6 w-6 text-primary mx-auto opacity-40" />
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 pt-20">
                                            ...
                                            <p className="text-lg font-black italic text-foreground leading-relaxed">
                                                "{(() => {
                                                    ...
                                                    const leverageMap: Record<string, Record<Locale, string>> = {
                                                        'Clareza Cognitiva': {
                                                            pt: 'Elimine todas as notificações digitais por 4 horas diárias na sua Golden Hour.',
                                                    ...
                                                    const pillarMap = leverageMap[bottleneck || ''] || leverageMap['Poder Executivo'];
                                ...
                                >
                                    <div className="absolute bottom-0 right-0 p-8 opacity-[0.03] group-hover:rotate-12 transition-transform">
                                        ...
                                        <div className="space-y-4">
                                            {[
                                                ...
                                                <div key={i} className="flex gap-4 items-start p-4 rounded-2xl bg-rose-500/5 border border-rose-500/10 hover:bg-rose-500/10 transition-colors group/item">
                                                    ...
                                                    <div className="space-y-1">
                                                        <div className="flex items-center gap-2">
                                                            <span className="text-xs font-black uppercase italic">{warning.label[lang] || warning.label['en']}</span>
                                                            <Badge className="text-[8px] bg-rose-500/10 text-rose-500 border-none px-1.5 py-0">Risk: {warning.risk}</Badge>
                                                        </div>
                                                        <p className="text-[11px] text-muted-foreground font-medium italic leading-relaxed">{warning.desc[lang] || warning.desc['en']}</p>
                                                    </div>
                                                </div>
                                            ))}
                                        </div>
                            ...
                            <div className="pt-24 pb-12">
                                <Card className="bg-gradient-to-br from-zinc-900 to-black border-primary/20 p-12 rounded-[4rem] text-center space-y-10 relative overflow-hidden group">
                                    ...
                                    <InfinityIcon className="h-12 w-12 mx-auto text-primary/40 animate-pulse" />
                                    <div className="space-y-4 relative z-10">
                            ...
                            <footer className="pt-20 pb-12 flex flex-col items-center gap-6 text-center opacity-30 no-print">
                                ...
                                <div className="space-y-1">
                                    ...
                                    <p className="text-[8px] uppercase font-bold tracking-[0.3em]">
                                        {lang === 'pt' ? '7 Pilares • Inteligência Neural AI • Resiliência Estoica' :
                                            lang === 'es' ? '7 Pilares • Inteligencia Neural AI • Resiliencia Estoica' :
                                                '7 Pillars • AI Neural Intelligence • Stoic Resilience'}
                                    </p>
                                </div>
                            </footer>
                        </>
